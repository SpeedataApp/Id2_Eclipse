...
public class MainActivity extends Activity {
	...
	private void initID() {
		...
		// handler.sendMessage(message);
		// }
		// }, mFile.exists() ? mConfig.getId2().getSerialPort() :
		// DeviceType.getSerialPort(),
		...
		// if (!result) {
		// new
		// AlertDialog.Builder(this).setCancelable(false).setMessage("二代证模块初始化失败")
		// .setPositiveButton("确定", new DialogInterface.OnClickListener() {
		//
		// @Override
		// public void onClick(DialogInterface dialogInterface, int i) {
		...
		public void handleMessage(Message msg) {
			...
			if (idInfor1.isSuccess()) {
				tvIDInfor.setText("姓名:" + idInfor1.getName() + "\n身份证号：" + idInfor1.getNum() + "\n性别："
						+ idInfor1.getSex() + "\n民族：" + idInfor1.getNation() + "\n住址:" + idInfor1.getAddress() + "\n出生："
						+ idInfor1.getYear() + "年" + idInfor1.getMonth() + "月" + idInfor1.getDay() + "日" + "\n有效期限："
						+ idInfor1.getDeadLine());
